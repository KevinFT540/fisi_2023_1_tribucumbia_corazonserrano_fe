...
class Habitaciones7 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_habitaciones7)
...
//                val url = "http://20.121.72.196:3000/api/reservar/v1/habitacion"
    ...
    fun usuariohabit7(view: View){
        val ushabit7 = Intent(this,Perfil::class.java)
        startActivity(ushabit7)
    }
}
